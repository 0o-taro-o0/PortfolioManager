...
from data_fetcher.investment import Trade
...
class TestInvestment(unittest.TestCase):
    def setUp(self):
        self.asset = Asset(Asset.Type.STOCK, 'AAPL')
    ...
    def test_record_trade(self):
        self.investment.record_trade('2021-12-10', Trade.Type.BUY, 100000)
        self.assertEqual(len(self.investment.trades), 1)
        self.assertEqual(self.investment.trades[0].trade_type, Trade.Type.BUY)
        self.assertEqual(self.investment.trades[0].amount, 100000)

    def test_get_state_at(self):
        self.investment.record_trade('2021-12-01', Trade.Type.BUY, 100000)
        date = '2021-12-15'
